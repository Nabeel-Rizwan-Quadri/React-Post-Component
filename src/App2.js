...
function App() {
    ...
    return ( <
...

        {
            ...
            <
            h1 > { currentQuestionIndex + 1 }) { questions[currentQuestionIndex].Question } <
        /h1>
        ...
        <
        h2 > { console.log(score) } { console.log(questions.length) } { score / 4 * 100 } %
        <
        /h2>

        <
        p >
        No.of correct answers { score } { < br > < /br>}
